...
export const Navbar = ({ className, ...props }: NavbarProps) => {
    ...
    return (
        ...
        <nav className={cn("fixed top-0 left-0 flex flex-col h-screen w-72 p-2 bg-slate-900 border-r border-indigo-400/20 hover:border-indigo-400/40 text-slate-300", className)} {...props} >
